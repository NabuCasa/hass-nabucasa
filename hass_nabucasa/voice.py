...
MAP_VOICE = {
    ...
    ("zh-CN", Gender.FEMALE): "XiaohanNeural",
    ("zh-CN", Gender.FEMALE): "XiaomoNeural",
    ("zh-CN", Gender.FEMALE): "XiaoruiNeural",
    ("zh-CN", Gender.FEMALE): "XiaoxiaoNeural",
    ("zh-CN", Gender.FEMALE): "XiaoxuanNeural",
    ("zh-CN", Gender.FEMALE): "XiaoyouNeural",
    ("zh-CN", Gender.MALE): "YunxiNeural",
    ("zh-CN", Gender.MALE): "YunyangNeural",
    ("zh-CN", Gender.MALE): "YunyeNeural",
    ...
    ("nl-NL", Gender.FEMALE): "FennaNeural",
    ...
    # Retired on 30 October 2021, requests will be redirected to SoniaNeural
    ("en-GB", Gender.FEMALE): "MiaNeural", 
    ("en-GB", Gender.FEMALE): "SoniaNeural",
    ("en-GB", Gender.MALE): "RyanNeural",
    ("en-US", Gender.FEMALE): "AmberNeural",
    ("en-US", Gender.FEMALE): "AriaNeural",
    ("en-US", Gender.FEMALE): "AshleyNeural",
    ("en-US", Gender.FEMALE): "CoraNeural",
    ("en-US", Gender.FEMALE): "ElizabethNeural",
    ("en-US", Gender.FEMALE): "JennyNeural",
    ("en-US", Gender.FEMALE): "MichelleNeural",
    ("en-US", Gender.FEMALE): "MonicaNeural",
    ("en-US", Gender.FEMALE): "SaraNeural",
    ("en-US", Gender.MALE): "AnaNeural",
    ("en-US", Gender.MALE): "BrandonNeural",
    ("en-US", Gender.MALE): "ChristopherNeural",
    ("en-US", Gender.MALE): "EricNeural",
    ("en-US", Gender.MALE): "GuyNeural",
    ("en-US", Gender.MALE): "JacobNeural",
    ...
    ("it-IT", Gender.FEMALE): "IsabellaNeural",
    ...
    ("nb-NO", Gender.FEMALE): "PernilleNeural",
    ...
    ("th-TH", Gender.FEMALE): "PremwadeeNeural",
