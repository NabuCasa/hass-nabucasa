...
# From https://learn.microsoft.com/en-us/azure/ai-services/speech-service/language-support?tabs=tts#supported-languages
TTS_VOICES = {
    "af-ZA": [
        "AdriNeural",
        "WillemNeural",
    ...
    "zh-CN": [
        ...
        "YunzeNeural",
        "YunfanMultilingualNeural",
        "YunxiaoMultilingualNeural",
    ],
    "zh-CN-GUANGXI": [
...
# from https://learn.microsoft.com/en-us/azure/ai-services/speech-service/language-support?tabs=stt#supported-languages
STT_LANGUAGES = [
    "af-ZA",
    "am-ET",
    "ar-AE",
...
class Voice:
    ...
    async def process_tts(
        ...
        *,
        ...
        voice_el.set(
            "name",
            f"Microsoft Server Speech Text to Speech Voice ({language}, {
                voice})",
        )
