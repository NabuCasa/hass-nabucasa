...
MAP_VOICE = {
    ...
    ("en-GB", Gender.FEMALE): "LibbyNeural, MiaNeural",
    ("en-GB", Gender.MALE): "RyanNeural",
    ("en-US", Gender.MALE): "GuyNeural",
    ("en-US", Gender.FEMALE): "AriaNeural, JennyNeural",
    ...
    ("it-IT", Gender.FEMALE): "ElsaNeural, IsabellaNeural",
    ...
    ("zh-CN", Gender.FEMALE): "XiaoxiaoNeural, XiaoyouNeural",
    ("zh-CN", Gender.MALE): "YunyangNeural, YunyeNeural",
    ...
    ("th-TH", Gender.FEMALE): "AcharaNeural, PremwadeeNeural",
