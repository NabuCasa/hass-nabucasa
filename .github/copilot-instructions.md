...
- Comments policy: Keep comments to a minimum — prefer clear names and structure. This covers docstrings too: keep them to a one-line summary unless there is something a reader genuinely can’t get from the code.
